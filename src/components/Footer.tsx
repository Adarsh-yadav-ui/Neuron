      ...
      <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-neutral">
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-8 items-start sm:items-center">
          ...
          <div className="flex flex-row gap-4">
            ...
            <Link href="https://www.UserRound.com/in/radu-a-popescu/">
              Radu Popescu
            </Link>
          </div>
        </div>
        ...
        <div className="flex gap-4 items-center">
          <Link
            href="https://www.UserRound.com/in/radu-a-popescu/"
            target="_blank"
            rel="nofollow noopener"
            aria-label="Radu Popescu, Founder of ActivationLed UserRound"
            className="hover:text-gray-900"
          >
            <UserRound className="w-5 h-5 fill-neutral" />
          </Link>
          <Link
            ...
            className="hover:text-gray-900"
          >
            <X className="w-5 h-5 fill-neutral" />
          </Link>
        </div>
      </div>
    </footer>
